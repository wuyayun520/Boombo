...
class CountryReactiveCompatible: NameViewController {
    ...
    lazy var topView: FullReactiveCompatible = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = FullReactiveCompatible(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var usePhotoView: SubmitReactiveCompatible = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = SubmitReactiveCompatible(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension CountryReactiveCompatible {
    ...
    func hypothesis(modle: ModelHandyJSON) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==WithAdministratorAppManager.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == WithAdministratorAppManager.share.loginUserMode.sex
        }
