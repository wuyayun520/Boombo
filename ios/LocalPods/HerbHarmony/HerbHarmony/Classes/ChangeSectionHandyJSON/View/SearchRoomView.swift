...
fileprivate let str_listTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Tips" :*/
fileprivate let str_headTitle:String = "data view height class toolTips"
...
class SearchRoomView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_listTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.textColor = UIColor.occurrence()
        //: lab.font = UIFont.liveAttention(type: .Semibold, fontSize: 22)
        lab.font = UIFont.liveAttention(type: .Semibold, fontSize: 22)
        //: lab.text = "Tips".localized
        lab.text = (String(str_headTitle.suffix(4))).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var textLab1: UILabel = {
        ...
        lab.text = String(bytes: str_atTitle.reversed(), encoding: .utf8)!.localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var textLab2: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_afterManagerData)))
        ...
        lab.text = String(bytes: str_toTitle.reversed(), encoding: .utf8)!.localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.nameColors(colors: UIColor.modelColor(), size: CGSize(width: 255, height: 50)), for: .normal)
...
extension SearchRoomView {
    //: func showView(okHandler: @escaping () -> Void) {
    func erase(okHandler: @escaping () -> Void) {
        //: show()
        eventCollectionShow()
        // bind event
        ...
        okBtn.rx.controlEvent(.touchUpInside)
            ...
            .subscribe(onNext: { [weak self] in
                ...
                kLet_dismissData.set(true, forKey: kLet_maxName)
                //: self.dismiss()
                self.signature()
                //: okHandler()
                okHandler()
    ...
    //: private func show() {
    private func eventCollectionShow() {
...
extension SearchRoomView {
    ...
    private func tap() {
        ...
        backgroundColor = UIColor.equalRgba(0, 0, 0, 0.6)
        //: alpha = 0
        alpha = 0
        //: addSubview(whiteBgV)
        addSubview(whiteBgV)
