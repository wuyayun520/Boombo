...
fileprivate let str_viewData:[UInt8] = [0xcc,0xd1,0xcc,0xd7,0x8b,0xc6,0xd2,0xc7,0xc8,0xd5,0x9d,0x8c,0x83,0xcb,0xc4,0xd6,0x83,0xd1,0xd2,0xd7,0x83,0xc5,0xc8,0xc8,0xd1,0x83,0xcc,0xd0,0xd3,0xcf,0xc8,0xd0,0xc8,0xd1,0xd7,0xc8,0xc7]

fileprivate func recommendationModel(input num: UInt8) -> UInt8 {
...
/*: "F5F5F5" :*/
fileprivate let str_matchData:String = "f5f5f5"
...
class ItemToThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_viewData.map{recommendationModel(input: $0)}, encoding: .utf8)!)
    }
    ...
    func popCell(isListTableCell: Bool) {
    ...
    lazy var userInfoView: CheckButtonThen = {
        //: let  view = TalkingMomentUserInfoView.init()
        let view = CheckButtonThen()
    ...
    lazy var textContentView: ButtonReactiveCompatible = {
        //: let  view = TalkingMomentTextContentView.init()
        let view = ButtonReactiveCompatible()
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var photoView: CoverLeadingThen = {
        ...
        let view = CoverLeadingThen(frame: CGRect(x: 0, y: 0, width: 0, height: 0), collectionViewLayout: flayout)
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var bottomView: LoadUpBottomView = {
        //: let  view = TalkingMomentItemBottomView.init()
        let view = LoadUpBottomView()
        //: backView.addSubview(view)
        backView.addSubview(view)
        //: return view
        return view
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (str_matchData.uppercased()))
        //: self.contentView.addSubview(view)
        self.contentView.addSubview(view)
        //: return view
        return view
...
//            }
            ...
            photoView.framework(model: cunrrenModel)
...
//            }
            ...
            videoView.perimeter(model: model.videoInfo!, isTop: model.pinStatus)
        }

        //: bottomView.configModel(model: cunrrenModel)
        bottomView.underEnter(model: cunrrenModel)
...
//        }
    ...
    @objc func constraint() {
        ...
        let vc = ViewManagerReactiveCompatible(videoPath: cunrrenModel.videoInfo!.videoUrl)
        //: if cunrrenModel.sex != WithAdministratorAppManager.share.loginUserMode.sex {
        if cunrrenModel.sex != WithAdministratorAppManager.share.loginUserMode.sex {
    ...
    func equidistant() {
        ...
        if cunrrenModel.momentType == StackClusterLiteral.Video.rawValue {
...
extension ItemToThen {
    ...
    private func littlenessSubviews() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(constraint))
