...
fileprivate let str_disappearText:[UInt8] = [0x80,0x87,0x80,0x9d,0xc1,0x8a,0x86,0x8d,0x8c,0x9b,0xd3,0xc0,0xc9,0x81,0x88,0x9a,0xc9,0x87,0x86,0x9d,0xc9,0x8b,0x8c,0x8c,0x87,0xc9,0x80,0x84,0x99,0x85,0x8c,0x84,0x8c,0x87,0x9d,0x8c,0x8d]

private func nameColor(log num: UInt8) -> UInt8 {
    return num ^ 233
}

/*: "icon_chat_start" :*/
fileprivate let str_directionData:String = "icomake"
fileprivate let str_cellName:[Character] = ["_","s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let str_userData:String = "bottom price model#752F"
fileprivate let str_equalData:[Character] = ["E","9"]

/*: "#F5F5F5" :*/
fileprivate let str_viewPathTitle:String = "i let#F5F5F5"

/*: "@ :*/
fileprivate let str_listValue:String = "define"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let str_makeSourceData:[UInt8] = [0x69,0x7b,0x75,0x66,0x6d,0x6c,0x6c,0x6b,0x66,0x6b,0x70,0x68,0x75,0x81,0x68,0x75,0x66,0x75,0x76,0x79]

fileprivate func atTouch(request num: UInt8) -> UInt8 {
    let value = Int(num) - 7
    if value < 0 {
...
/*: "btn_feed_reply_nor" :*/
fileprivate let str_emptyModeData:String = "btn_fmodel show"
fileprivate let str_giftValue:String = "centerply"
fileprivate let str_labValue:[Character] = ["_","n","o","r"]
...
class WithThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_disappearText.map{nameColor(log: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.nearCounterval(name: (str_directionData.replacingOccurrences(of: "make", with: "n") + "_chat" + String(str_cellName)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_userData.suffix(5)) + String(str_equalData)))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_viewPathTitle.suffix(7))))
...
extension WithThen {
    ...
    func upOf(_ model: VoiceListModel) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.commentGesture(urlStr: model.headPic, placeImg: UIImage.firstMake())
        ...
        previewImgView.nearSquare(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: str_makeSourceData.map{atTouch(request: $0)}, encoding: .utf8)! : (String(str_emptyModeData.prefix(5)) + "eed_r" + str_giftValue.replacingOccurrences(of: "center", with: "e") + String(str_labValue))
        //: statusIcon.image = UIImage.nearCounterval(name: typeImgStr)
        statusIcon.image = UIImage.nearCounterval(name: typeImgStr)
