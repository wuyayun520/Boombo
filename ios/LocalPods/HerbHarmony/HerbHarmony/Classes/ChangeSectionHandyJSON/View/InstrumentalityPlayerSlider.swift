...
fileprivate let str_makeTimeValue:[UInt8] = [0x8a,0x8d,0x8a,0x97,0xcb,0x80,0x8c,0x87,0x86,0x91,0xd9,0xca,0xc3,0x8b,0x82,0x90,0xc3,0x8d,0x8c,0x97,0xc3,0x81,0x86,0x86,0x8d,0xc3,0x8a,0x8e,0x93,0x8f,0x86,0x8e,0x86,0x8d,0x97,0x86,0x87]
...
// __CLOSE_PRINT__
//
//  InstrumentalityPlayerSlider.swift
//  AbroadTalking
//
...
class InstrumentalityPlayerSlider: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_makeTimeValue.map{$0^227}, encoding: .utf8)!)
    }
    ...
    private lazy var progressView: VoiceThen = {
        ...
        let v = VoiceThen(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(cookwareInsideGesture(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(poking(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension InstrumentalityPlayerSlider {
    //: @objc func panGesture(gesture: UIPanGestureRecognizer) {
    @objc func cookwareInsideGesture(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func poking(gesture: UIPanGestureRecognizer) {
...
extension InstrumentalityPlayerSlider {
    ...
    private func freeSpokenSubviews() {
