...
/*: "Face verification" :*/
fileprivate let str_frameClickTitle:String = "Face vif return"
fileprivate let str_toTitle:String = "icpostion"
...
class IconViewController: NameViewController {
    ...
    override func viewDidLoad() {
        ...
        title = (String(str_frameClickTitle.prefix(6)) + "erif" + str_toTitle.replacingOccurrences(of: "post", with: "at")).localized
        //: self.createUI()
        self.event()
        //: self.createUIConstraint()
        self.makeForToRestrictionStatus()
    }

    // MARK: - Lazy load

    //: lazy var mainView: TalkingVerificationExampleView = {
    lazy var mainView: ChangeExampleView = {
        //: let view = TalkingVerificationExampleView()
        let view = ChangeExampleView()
        //: return view
        return view
        //: }()
    }()
...
extension IconViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = BackThen(photoImage: photo)
...
extension IconViewController {
    ...
    func event() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            LaissezPasserThen.effectOf(true) { isOpen in
    ...
    func makeForToRestrictionStatus() {
