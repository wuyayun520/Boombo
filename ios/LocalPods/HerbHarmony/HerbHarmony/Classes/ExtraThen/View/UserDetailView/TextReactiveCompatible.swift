...
fileprivate let str_scaleTitle:[UInt8] = [0xd2,0xd5,0xd2,0xcf,0x93,0xd8,0xd4,0xdf,0xde,0xc9,0x81,0x92,0x9b,0xd3,0xda,0xc8,0x9b,0xd5,0xd4,0xcf,0x9b,0xd9,0xde,0xde,0xd5,0x9b,0xd2,0xd6,0xcb,0xd7,0xde,0xd6,0xde,0xd5,0xcf,0xde,0xdf]

private func shareFree(gift num: UInt8) -> UInt8 {
    return num ^ 187
}

/*: "Gifts received" :*/
fileprivate let str_sizeTitleInValue:[Character] = ["G","i","f","t","s"," ","r"]
fileprivate let str_signData:String = "ECEIVED"
...
class TextReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_scaleTitle.map{shareFree(gift: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(str_sizeTitleInValue) + str_signData.lowercased()).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(ItemViewCell.self, forCellWithReuseIdentifier: ItemViewCell.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension TextReactiveCompatible: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ItemViewCell.className(), for: indexPath) as! ItemViewCell
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: StateMagnitudeModelType = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.viewSection(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
...
extension TextReactiveCompatible {
    ...
    private func subviewsRootFrame() {
