...
class UserStatePowerToolThen: NSObject {
...
extension UserStatePowerToolThen {
    /// 释放资源
    ...
    func frontName(_ frontCamera: Bool) {
        ...
        self.aware(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func starFrom(_ openCamera: Bool) {
        ...
        self.setWithoutOn(isOpen: openCamera)
    }
    ...
    func sinceRender() {
        ...
        DispatchQueue.main.async {
            ...
            self.averageCost(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension UserStatePowerToolThen {
    ...
    private func setWithoutOn(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_tabTitle == true else {
            //: if isOpen {
            if isOpen {
...
extension UserStatePowerToolThen {
    ...
    func nameTag() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(directorate(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(halogen(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(beforeCounteraction(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(picCell(notif:)),
    ...
    @objc private func directorate(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func halogen(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func beforeCounteraction(notif: Notification) {
    ...
    @objc func picCell(notif: Notification) {
...
extension UserStatePowerToolThen {
    ...
    func averageCost(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_tabTitle == true else {
