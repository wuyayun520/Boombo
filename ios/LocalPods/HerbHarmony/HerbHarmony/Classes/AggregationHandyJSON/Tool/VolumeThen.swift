...
/*: "App" :*/
fileprivate let str_indexValue:String = "Applab model make of"

/*: "blockList_ :*/
fileprivate let str_equalValue:String = "count icon control loadblockL"
fileprivate let str_nearValue:[Character] = ["i","s","t","_"]
...
class VolumeThen: NSObject {
    ...
    func openClick(userId: String) -> Bool {
    ...
    private func fileSizeHide() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(str_indexValue.prefix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(str_equalValue.suffix(6)) + String(str_nearValue)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
