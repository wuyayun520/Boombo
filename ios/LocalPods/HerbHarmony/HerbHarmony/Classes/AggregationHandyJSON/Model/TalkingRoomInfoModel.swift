...
/*: "id" :*/
fileprivate let str_dataValue:String = "iresult"
...
enum TypeChangeMagnitudeLiteral: Int {
    //: case normal = 1
    case normal = 1 // 普通礼物
    //: case myStery  = 2
    case myStery = 2 // 盲盒礼物
...
struct GiftSectionModelType: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct FromTransformable: HandyJSON {
