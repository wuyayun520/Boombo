...
fileprivate let str_cellModelData:[UInt8] = [0x41,0x46,0x41,0x5c,0x0,0x4b,0x47,0x4c,0x4d,0x5a,0x12,0x1,0x8,0x40,0x49,0x5b,0x8,0x46,0x47,0x5c,0x8,0x4a,0x4d,0x4d,0x46,0x8,0x41,0x45,0x58,0x44,0x4d,0x45,0x4d,0x46,0x5c,0x4d,0x4c]

private func toVoice(touch num: UInt8) -> UInt8 {
    return num ^ 40
}

/*: "icon_livetc_warn" :*/
fileprivate let str_managerValue:String = "frame key flow mediumicon_"
fileprivate let str_hourModelTitle:[Character] = ["a","r","n"]

/*: "OK" :*/
fileprivate let str_hiddenUserData:String = "name"
...
class PriceReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_cellModelData.map{toVoice(touch: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.nearCounterval(name: "icon_livetc_warn")
        iamg.image = UIImage.nearCounterval(name: (String(str_managerValue.suffix(5)) + "livetc_w" + String(str_hourModelTitle)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = WithAdministratorAppManager.share.appUserConfigMode.blockCameraPopupContent
        lab.text = WithAdministratorAppManager.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(cabotageLikeMove), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PriceReactiveCompatible {
    ...
    @objc private func cabotageLikeMove() {
        //: dismiss()
        scope()
    }
}
