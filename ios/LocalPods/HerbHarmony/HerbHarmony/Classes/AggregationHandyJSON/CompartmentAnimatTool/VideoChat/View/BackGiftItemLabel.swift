...
fileprivate let str_extraName:[UInt8] = [0x2d,0x2a,0x2d,0x30,0x6c,0x27,0x2b,0x20,0x21,0x36,0x7e,0x6d,0x64,0x2c,0x25,0x37,0x64,0x2a,0x2b,0x30,0x64,0x26,0x21,0x21,0x2a,0x64,0x2d,0x29,0x34,0x28,0x21,0x29,0x21,0x2a,0x30,0x21,0x20]

private func locationAttention(button num: UInt8) -> UInt8 {
    return num ^ 68
}
...
class BackGiftItemLabel: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [ButtonModelType()]
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: frame)
        //: self.setupSubviews()
        self.physicalPropertyLive()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: str_extraName.map{locationAttention(button: $0)}, encoding: .utf8)!)
    }
    ...
    func quoteWithSearched(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.colorPush()
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.equalRgba(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.equalRgba(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension BackGiftItemLabel {
    // 添加视图
    //: private func setupSubviews() {
    private func physicalPropertyLive() {
