...
fileprivate let str_fileName:[UInt8] = [0x18,0x1f,0x18,0x5,0x59,0x12,0x1e,0x15,0x14,0x3,0x4b,0x58,0x51,0x19,0x10,0x2,0x51,0x1f,0x1e,0x5,0x51,0x13,0x14,0x14,0x1f,0x51,0x18,0x1c,0x1,0x1d,0x14,0x1c,0x14,0x1f,0x5,0x14,0x15]

private func informationList(frame num: UInt8) -> UInt8 {
    return num ^ 113
}
...
class ViewCell: MTouchMsgCell {
    //: var giftData: ButtonCellData?
    var giftData: ButtonCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_fileName.map{informationList(frame: $0)}, encoding: .utf8)!)
    }
...
extension ViewCell {
    ...
    override func fill(with data: TCommonCellData) {
        ...
        super.fill(with: data)
        //: self.giftData = data as? ButtonCellData
        self.giftData = data as? ButtonCellData
