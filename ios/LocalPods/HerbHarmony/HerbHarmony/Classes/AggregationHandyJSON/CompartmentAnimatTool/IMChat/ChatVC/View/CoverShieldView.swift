...
class CoverShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func appNameSave(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return CoverShieldView(frame: frame)
    }
