...
/*: _" :*/
fileprivate let str_actualName:String = "_"

/*: ".png" :*/
fileprivate let str_listInfoName:[Character] = [".","p","n","g"]
...
//: @objcMembers public class IndexClearThen: TalkingChatMsgBaseCellData {
@objcMembers public class IndexClearThen: CollectionReactiveCompatible {
    ...
    override public var msgModel: DataNameModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.informationData(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func largess(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kLet_appText)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + WithAdministratorAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + WithAdministratorAppManager.share.loginUserMode.userID + (String(str_listInfoName))
        ...
        let imageData = UIImage.location(image, custom: 2 * 1024)
