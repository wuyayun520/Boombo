...
@objcMembers public class TalkingSystemMsgCellData: TUIMessageCellData {
    ...
    var contentFont = UIFont.unprecedented(fontSize: 13)
    var contentColor = UIColor.inexpensiveness()
    ...
    public override func contentSize() -> CGSize {
        let textSize = CGSize(width: kLet_senseContent/2, height: kLet_environmentClickValue)
