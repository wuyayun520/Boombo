...
/*!消息体数据*/
//: @class LikeModel, CenterUserModel, AbTalkingChatMsgToUserModel, AbTalkingChatMsgGiftModel, PathJsonModel, CoverThen, HypothesisModel, ValueJsonModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, TelecastingModel;
@class LikeModel, CenterUserModel, StyleJsonModel, ManagerModel, PathJsonModel, CoverThen, HypothesisModel, ValueJsonModel, TalkingModel, PathModel, ByJsonModel, TelecastingModel;

//: @interface DataNameModel : BaseJsonModel
@interface DataNameModel : BaseJsonModel

//: @property (nonatomic, strong)LikeModel *msgInfo;
@property (nonatomic, strong)LikeModel *msgInfo;

//: @property (nonatomic, strong)CenterUserModel *user;
@property (nonatomic, strong)CenterUserModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)StyleJsonModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)ManagerModel *gift;

//: @property (nonatomic, strong)PathJsonModel *tips;
@property (nonatomic, strong)PathJsonModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)PathModel *quoteMsgInfo;

//: @property (nonatomic, strong)CoverThen *userInfoModel;
@property (nonatomic, strong)CoverThen *userInfoModel;
...
//: @interface LikeModel : BaseJsonModel
@interface LikeModel : BaseJsonModel
...
//: @property (nonatomic, strong) HypothesisModel *intimatePhoto; 
@property (nonatomic, strong) HypothesisModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) ValueJsonModel *video; 
@property (nonatomic, strong) ValueJsonModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) TalkingModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) TelecastingModel *wantGift; 
@property (nonatomic, strong) TelecastingModel *wantGift; /// 想要礼物
...
/// 私密照片模型
//: @interface HypothesisModel : BaseJsonModel
@interface HypothesisModel : BaseJsonModel
...
/// 视频（包含私密视频）模型
//: @interface ValueJsonModel: BaseJsonModel
@interface ValueJsonModel: BaseJsonModel
...
@interface TalkingModel: BaseJsonModel
...
//消息发送人
//: @interface CenterUserModel : BaseJsonModel
@interface CenterUserModel : BaseJsonModel
...
@interface StyleJsonModel : BaseJsonModel
...
@interface ManagerModel : BaseJsonModel
...
//: @interface PathJsonModel : BaseJsonModel
@interface PathJsonModel : BaseJsonModel
...
//: @interface TelecastingModel : BaseJsonModel
@interface TelecastingModel : BaseJsonModel
...
@interface PathModel : BaseJsonModel
...
@property (nonatomic, strong) ByJsonModel *renderData;
...
@interface ByJsonModel : BaseJsonModel
