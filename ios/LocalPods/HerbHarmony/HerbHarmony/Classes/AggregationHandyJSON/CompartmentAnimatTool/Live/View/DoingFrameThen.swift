...
fileprivate let str_lockData:[UInt8] = [0x9,0xe,0x9,0x14,0x48,0x3,0xf,0x4,0x5,0x12,0x5a,0x49,0x40,0x8,0x1,0x13,0x40,0xe,0xf,0x14,0x40,0x2,0x5,0x5,0xe,0x40,0x9,0xd,0x10,0xc,0x5,0xd,0x5,0xe,0x14,0x5,0x4]

private func serverLet(view num: UInt8) -> UInt8 {
    return num ^ 96
}

/*: "icon_tc_warn" :*/
fileprivate let str_jumpTitle:String = "icon_tpersonal max of"
fileprivate let str_stopTitle:[Character] = ["c"]
fileprivate let str_equalText:String = "core var value_warn"

/*: "Live Warning" :*/
fileprivate let str_piFireData:String = "limit by hidden index messageLive "

/*: "OK" :*/
fileprivate let str_makeValue:[Character] = ["O","K"]

/*: "Violation Reason: " :*/
fileprivate let str_pathIndexTitle:[Character] = ["V","i","o","l","a","t","i","o","n"," ","R"]
fileprivate let str_norName:[Character] = ["e","a","s","o","n",":"," "]

/*: "Warning Time: " :*/
fileprivate let str_backPlayerText:String = "self light letWarn"
fileprivate let str_youTitle:String = "class self selfme: "
...
class DoingFrameThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_lockData.map{serverLet(view: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.nearCounterval(name: "icon_tc_warn")
        iamg.image = UIImage.nearCounterval(name: (String(str_jumpTitle.prefix(6)) + String(str_stopTitle) + String(str_equalText.suffix(5))))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(str_piFireData.suffix(5)) + "Warning").localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(objectSub), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension DoingFrameThen {
    ...
    func activity(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.alright()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.alright()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(str_pathIndexTitle) + String(str_norName)).localized
        ...
        var timeText = (String(str_backPlayerText.suffix(4)) + "ing Ti" + String(str_youTitle.suffix(4))).localized
