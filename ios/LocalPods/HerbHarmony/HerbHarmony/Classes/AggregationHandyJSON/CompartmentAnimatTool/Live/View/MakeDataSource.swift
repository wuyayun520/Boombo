...
fileprivate let str_topViewValue:[UInt8] = [0x4f,0x48,0x4f,0x52,0xe,0x45,0x49,0x42,0x43,0x54,0x1c,0xf,0x6,0x4e,0x47,0x55,0x6,0x48,0x49,0x52,0x6,0x44,0x43,0x43,0x48,0x6,0x4f,0x4b,0x56,0x4a,0x43,0x4b,0x43,0x48,0x52,0x43,0x42]

private func titleImage(to num: UInt8) -> UInt8 {
    return num ^ 38
}

/*: "Online Users" :*/
fileprivate let str_activityValue:[Character] = ["O","n","l","i","n"]
fileprivate let str_layerData:String = "greet extra elsee Users"

/*: "ChangeListCell" :*/
fileprivate let str_showInfoTitle:[Character] = ["T","a","l","k","i","n","g","L","i","v"]
fileprivate let str_colorData:[Character] = ["e","R","o","o","m","O","n","l","i","n","e","L","i","s","t","C","e","l","l"]
...
class MakeDataSource: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_topViewValue.map{titleImage(to: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var dismissBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(overMode), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLb: UILabel = {
        ...
        lb.text = (String(str_activityValue) + String(str_layerData.suffix(7))).localized
        //: return lb
        return lb
        //: }()
    }()
...
extension MakeDataSource {
    ...
    private func addTwentieth() {
        //: TalkingAudienceManager().req_liveRoomOnlineList(chatGroupId: self.chatGroupId) { succeed, result, errorModel in
        StickToAudienceManager().completionTapLanthanoidOpenlineRoomListTent(chatGroupId: self.chatGroupId) { succeed, result, _ in
            ...
            if succeed {
                ...
                if let datas = Array<SectionListModel>.deserialize(from: array as? Array) {
...
extension MakeDataSource: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = (String(str_showInfoTitle) + String(str_colorData))
        ...
        cell?.vieUser(model: self.DataSource[indexPath.row], index: indexPath.row)
        //: return cell!
        return cell!
    }
...
extension MakeDataSource {
    ...
    func leftEqual(chatGroupId: String) {
