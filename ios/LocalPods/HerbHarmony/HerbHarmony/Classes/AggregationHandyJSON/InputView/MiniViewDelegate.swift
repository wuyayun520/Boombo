...
fileprivate let str_backgroundValue:[UInt8] = [0x6b,0x70,0x6b,0x76,0x2a,0x65,0x71,0x66,0x67,0x74,0x3c,0x2b,0x22,0x6a,0x63,0x75,0x22,0x70,0x71,0x76,0x22,0x64,0x67,0x67,0x70,0x22,0x6b,0x6f,0x72,0x6e,0x67,0x6f,0x67,0x70,0x76,0x67,0x66]

fileprivate func addCornerDrop(border num: UInt8) -> UInt8 {
...
/*: "#292929" :*/
fileprivate let str_dateData:String = "#2929"
fileprivate let str_colorData:[Character] = ["2","9"]

/*: "9999999" :*/
fileprivate let str_norValue:String = "9999999"

/*: "icon_coin" :*/
fileprivate let str_titleData:[Character] = ["i","c"]
fileprivate let str_liveValue:String = "on_coinview key true"

/*: "icon_gift_more_arrow" :*/
fileprivate let str_sharedValue:[Character] = ["i","c","o","n","_","g"]
fileprivate let str_scaleColorValue:[Character] = ["i","f","t","_","m","o","r","e","_","a","r","r","o","w"]

/*: "RoomGiftCell" :*/
fileprivate let str_intimateValue:String = "Talkmodel title style else"
fileprivate let str_nameValue:String = "nearka"
fileprivate let str_lastData:[Character] = ["e","l","l"]

/*: "Hot" :*/
fileprivate let str_appData:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let str_popPathValue:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let str_mapText:[Character] = ["B","a","g","s"]

/*: "icon_gift_num_arrow" :*/
fileprivate let str_whiteName:String = "icon_target at"
fileprivate let str_dismissTitle:[Character] = ["n","u","m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let str_pageContent:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let str_colorEffectDefineData:String = "data filenav_"
fileprivate let str_yearName:String = "max tap_blac"
fileprivate let str_toCookiePlayName:[Character] = ["k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let str_equalAllValue:[UInt8] = [0xb5,0x89,0x84,0xc1,0x8f,0x94,0x8c,0x83,0x84,0x93,0xc1,0x8e,0x87,0xc1,0x86,0x88,0x87,0x95,0x92,0xc1,0x82,0x80,0x8f,0x8f,0x8e,0x95,0xc1,0x83,0x84,0xc1,0x8d,0x84,0x92,0x92,0xc1,0x95,0x89,0x80,0x8f,0xc1,0xd0]

private func dataModelCorner(request num: UInt8) -> UInt8 {
    return num ^ 225
}

/*: "Please select a gift" :*/
fileprivate let str_editAtValue:[Character] = ["P","l","e","a","s","e"," "]
fileprivate let str_cameraContent:String = "live"
fileprivate let str_countText:String = "ELEC"

/*: "Please select an object" :*/
fileprivate let str_topName:String = "Pleaas else bottom string empty"
fileprivate let str_sharedData:String = "ELEC"
fileprivate let str_identityValue:String = " objectregister birth table remove for"

/*: "Select the desired gift to unlock" :*/
fileprivate let str_labStyleData:[UInt8] = [0x76,0x40,0x49,0x40,0x46,0x51,0x5,0x51,0x4d,0x40,0x5,0x41,0x40,0x56,0x4c,0x57,0x40,0x41,0x5,0x42,0x4c,0x43,0x51,0x5,0x51,0x4a,0x5,0x50,0x4b,0x49,0x4a,0x46,0x4e]

/*: "OK" :*/
fileprivate let str_liveData:String = "contentK"

/*: "Select object >" :*/
fileprivate let str_wrapName:[Character] = ["S"]
fileprivate let str_finishText:String = "true for lab dismisselect "
fileprivate let str_valueContent:String = "ct >result select self data room"

/*: "It looks like there's nothing" :*/
fileprivate let str_voiceData:String = "It loelse today"
fileprivate let str_sizeContent:String = "none blockike t"
fileprivate let str_managerValue:String = "\'s no"

/*: "FF75A4" :*/
fileprivate let str_priorityTitle:[Character] = ["F","F","7","5","A"]
fileprivate let str_listData:[Character] = ["4"]

/*: "E570FF" :*/
fileprivate let str_cellData:[Character] = ["E","5","7","0","F","F"]

/*: "Ask for" :*/
fileprivate let str_makeValue:String = "Ask fview view with text task"
fileprivate let str_bottomData:String = "OR"

/*: " Select %@ > " :*/
fileprivate let str_smartCellTitle:[Character] = [" ","S","e","l","e","c","t"," ","%"]
fileprivate let str_modelLiveHeightValue:String = "@ > "

/*: "All Numbers" :*/
fileprivate let str_rowContent:String = "All bar time"
fileprivate let str_atDiskValue:[Character] = ["e","r","s"]

/*: "View detailed description >" :*/
fileprivate let str_roomName:String = "View dmake to view start succeed"
fileprivate let str_sharedName:String = "near returned des"
fileprivate let str_beautyMessageAsName:String = "cfirstpti"

/*: "\n" :*/
fileprivate let str_dayValue:String = "\n"

/*: "%.2f" :*/
fileprivate let str_topValue:[Character] = ["%",".","2","f"]

/*: "9999" :*/
fileprivate let str_tipName:String = "9999"

/*: "Custom" :*/
fileprivate let str_touchValue:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let str_tagPlusData:String = "voice app other gift colormf_co"
fileprivate let str_colorText:String = "igroup"

/*: "showBagsRed" :*/
fileprivate let str_instanceValue:[Character] = ["s","h","o","w","B","a","g"]
fileprivate let str_statusMePathValue:String = "sRedlab to bottom"
...
enum ScaleLargessComparable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
typealias SendFunctionBlock = (_ giftModel: GiftSectionModelType, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: GiftSectionModelType, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: GiftSectionModelType) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: GiftSectionModelType, _ num: String, _ model: PopScaleReactiveCompatible) -> Void
// 隐藏礼物面板Block
...
private let kLet_deviceTitle = 44.0
//: let GiftScrollContentView_H = 252.0
let kLet_eventValue = 252.0
//: private let pageControl_H = 7.0
private let kLet_greetTitle = 7.0
//: private let bottomView_H = 44.0
private let kLet_tableValue = 44.0
...
class MiniViewDelegate: UIView {
    ...
    var showOtherInputView = false
    //: var contentHeight = topView_H + GiftScrollContentView_H + pageControl_H + bottomView_H + kLet_appMarginText
    var contentHeight = kLet_deviceTitle + kLet_eventValue + kLet_greetTitle + kLet_tableValue + kLet_appMarginText
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [CustomInsetTarget]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = CustomInsetTarget.Hot
    ...
    init(frame: CGRect = .zero, style: ScaleLargessComparable = .normal, titlesArr: [CustomInsetTarget] = [.Hot, .Vip, .Bags]) {
        ...
        if self.style == .party {
            ...
            contentHeight += kLet_marginTitle
        }
        //: setupSubviews()
        noEvaluate()
        //: bindInteraction()
        weltanschauungQuantityeraction()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_backgroundValue.map{addCornerDrop(border: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        content.backgroundColor = .init(hex: (str_dateData.capitalized + String(str_colorData)))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.corners(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: IconReactiveCompatible = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: kLet_marginTitle)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = IconReactiveCompatible(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: kLet_deviceTitle)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (str_dateData.capitalized + String(str_colorData)))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: RoomThen = {
        //: let btn = TalkingButton()
        let btn = RoomThen()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.liveAttention(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.liveAttention(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((str_norValue.capitalized), for: .normal)
        //: btn.setImage(UIImage.nearCounterval(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.nearCounterval(name: (String(str_titleData) + String(str_liveValue.prefix(7)))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(errorRecord), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        let img = UIImageView()
        //: img.image = UIImage.nearCounterval(name: "icon_gift_more_arrow")
        img.image = UIImage.nearCounterval(name: (String(str_sharedValue) + String(str_scaleColorValue)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.equalRgba(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.equalRgba(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(RoomGiftCell.self, forCellWithReuseIdentifier: (String(str_intimateValue.prefix(4)) + "ingP" + str_nameValue.replacingOccurrences(of: "near", with: "ac") + "geGiftC" + String(str_lastData)))
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: RitualThen = //: return hotGiftCollectionView.collectionViewLayout as! RitualThen
        hotGiftCollectionView.collectionViewLayout as! RitualThen
    //: }()
    ...
    private lazy var titleScrollView: ScrollThen = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        for type in titlesArr {
            ...
            case .Hot:
                ...
                titles.append((String(str_appData)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((String(str_popPathValue)).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(str_mapText)).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = TargetFrameSegmentStyle()
        ...
        let scrollview = ScrollThen(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(kLet_deviceTitle)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if MeanSunLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = IconThen.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = IconThen.atWidth() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !SumReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        //: let view = UIView.init()
        let view = UIView()
        //: view.layer.borderColor  = UIColor.alright().cgColor
        view.layer.borderColor = UIColor.alright().cgColor
    ...
    private lazy var giftNumButton: RoomThen = {
        ...
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setImage(UIImage.nearCounterval(name: "icon_gift_num_arrow"), for: .normal)
        btn.setImage(UIImage.nearCounterval(name: (String(str_whiteName.prefix(5)) + "gift_" + String(str_dismissTitle))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(upWithTime), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        //: let btn = UIButton.init()
        let btn = UIButton()
        //: btn.titleLabel?.font = UIFont.liveAttention(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.liveAttention(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.alright()
        btn.backgroundColor = UIColor.alright()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(str_pageContent)).localized, for: .normal)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: ScreenHeight - CGFloat(keyborHeight) - 44, width: ScreenWidth, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.nearCounterval(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.nearCounterval(name: (String(str_colorEffectDefineData.suffix(4)) + "back" + String(str_yearName.suffix(5)) + String(str_toCookiePlayName))).withRenderingMode(.alwaysTemplate)
        ...
        //: sendButton.setBackgroundColor(color: .alright(), forState: .normal)
        sendButton.backgroundBlock(color: .alright(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(str_pageContent)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.atShow(showMsg: String(bytes: str_equalAllValue.map{dataModelCorner(request: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.atShow(showMsg: (String(str_editAtValue) + str_cameraContent.replacingOccurrences(of: "live", with: "s") + str_countText.lowercased() + "t a gift").localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.atShow(showMsg: (String(str_topName.prefix(4)) + "se s" + str_sharedData.lowercased() + "t an" + String(str_identityValue.prefix(7))).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = CustomInsetTarget(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.listLabel(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: GiftSectionModelType = dataArr[index] as! GiftSectionModelType
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(signalMake(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(totaleractionOfBottom(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(sumKeyboard(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: str_labStyleData.map{$0^37}, encoding: .utf8)!.localized
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(str_wrapName) + String(str_finishText.suffix(6)) + "obje" + String(str_valueContent.prefix(4))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(seleteWithinClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(totalIn), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        //: lab.textColor = .white
        lab.textColor = .white
        //: lab.font = UIFont.liveAttention(type: .Regular, fontSize: 16)
        lab.font = UIFont.liveAttention(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(str_voiceData.prefix(5)) + "oks l" + String(str_sizeContent.suffix(5)) + "here" + str_managerValue + "thing").localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.nameColors(colors: [UIColor(hex: (String(str_priorityTitle) + String(str_listData)))!.cgColor, UIColor(hex: (String(str_cellData)))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.liveAttention(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.liveAttention(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(str_makeValue.prefix(5)) + str_bottomData.lowercased()).localized, for: .normal)
...
extension MiniViewDelegate {
    ...
    @objc private func execute() {
        ...
        guard let dataType = CustomInsetTarget(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.listLabel(dataType: dataType)
    ...
    @objc func seleteWithinClick() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = TokenViewDelegate(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func totalIn() {
        //: dismissView()
        actionValue()
        //: LeadingEqualReactiveCompatible.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        LeadingEqualReactiveCompatible.share.enableLine(webViewType: .luckyBlindBox)
    }

    /// 索要礼物
    //: @objc func askforBtnClick() {
    @objc func spectrograph() {
        //: guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
        guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
            //: self.func__showStatusBarErrorMsg(showMsg: "Please select a gift".localized)
            self.atShow(showMsg: (String(str_editAtValue) + str_cameraContent.replacingOccurrences(of: "live", with: "s") + str_countText.lowercased() + "t a gift").localized)
...
extension MiniViewDelegate {
    ...
    func constraintContainer(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.listLabel(dataType: self.currType) as! [GiftSectionModelType]
            // 找到当前背包礼物索引，更新数量
            ...
            SumReactiveCompatible.share.slight(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.rubricSportsPage(force: true)
        }
    }
}
...
extension MiniViewDelegate: ToViewDelegate {
    ...
    func needList(model: PopScaleReactiveCompatible) {
        ...
        seleteObjectBtn.setTitle((String(str_smartCellTitle) + str_modelLiveHeightValue.capitalized).localizedArguments(model.nickname), for: .normal)
    }
    ...
    func towardError() {
        ...
        if model.nickname == (String(str_rowContent.prefix(4)) + "Numb" + String(str_atDiskValue)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! PopScaleReactiveCompatible
    ...
    func tapText(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(str_roomName.prefix(6)) + "etail" + String(str_sharedName.suffix(6)) + str_beautyMessageAsName.replacingOccurrences(of: "first", with: "ri") + "on >").localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension MiniViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func listLabel(dataType: CustomInsetTarget) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return SumReactiveCompatible.share.trailhead(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func dowry() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return SumReactiveCompatible.share.greetShared()
    }
    ...
    func aperture(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == TypeChangeMagnitudeLiteral.myStery.rawValue)
        }
    ...
    @objc fileprivate func signalMake(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (str_tipName.capitalized)
            //: } else {
        } else {
    ...
    @objc func sumKeyboard(notification: NSNotification) {
    ...
    @objc func totaleractionOfBottom(notification _: NSNotification) {
...
//            text += "  " + (giftNumArrModel.tag ?? "")
    ...
    func breakupNum() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? RoomGiftCell
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.prevalence(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = CustomInsetTarget(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = listLabel(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = (String(str_intimateValue.prefix(4)) + "ingP" + str_nameValue.replacingOccurrences(of: "near", with: "ac") + "geGiftC" + String(str_lastData))
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! RoomGiftCell
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = CustomInsetTarget(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = listLabel(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: GiftSectionModelType = dataArr[indexPath.row] as! GiftSectionModelType
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.lab(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.observerAccept(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = CustomInsetTarget(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = listLabel(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == TypeChangeMagnitudeLiteral.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == TypeChangeMagnitudeLiteral.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == TypeChangeMagnitudeLiteral.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                photoName(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = tanner(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = repayIndex(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            photoName(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: RoomGiftCell = giftSelectedModel.lastHotCell as! RoomGiftCell
                //: cell.setChecked(checked: false)
                cell.observerAccept(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: RoomGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! RoomGiftCell
            //: currentCell.setChecked(checked: true)
            currentCell.observerAccept(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.showSex(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.listLabel(dataType: self.currType)
    ...
    func rubricSportsPage(force: Bool = false) {
        // 计算page
        ...
        var giftType = CustomInsetTarget.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = SumReactiveCompatible.share.serviceType(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.channel(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && WithAdministratorAppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == CustomInsetTarget.Hot && self.style == .normal && WithAdministratorAppManager.share.loginUserMode.sex == MiniSubqueryConvertible.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == TypeChangeMagnitudeLiteral.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                tapText(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func confirmModel() {
        ...
        self.giftSelectedModel = FromTransformable()
...
// MARK: - IconChangeViewDelegate

//: extension TalkingChatGiftView: DropDownMenuViewDelegate {
extension MiniViewDelegate: IconChangeViewDelegate {
    ...
    func postPush(index: Int, title: String) {
        ...
        photoName(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func photoName(index: Int, title _: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = buttIn(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.bluntEnd(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.inwards(view: self.window!)
    ...
    func buttIn(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: ButtonModelType = sendingItems[index] as! ButtonModelType
    ...
    func repayIndex(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > dowry().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension MiniViewDelegate {
    ...
    private func noEvaluate() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(actionValue)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(kLet_eventValue)
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(kLet_greetTitle)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(kLet_tableValue)
        }
    ...
    private func weltanschauungQuantityeraction() {
        //: WithAdministratorAppManager.share.loginUserMode.rx
        WithAdministratorAppManager.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(str_tagPlusData.suffix(5)) + str_colorText.replacingOccurrences(of: "group", with: "n")))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.aperture(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        SumReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(str_instanceValue) + String(str_statusMePathValue.prefix(4))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                SumReactiveCompatible.share.dialog(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: WithAdministratorAppManager.share.loginUserMode.mf_coin)
                    self.aperture(needReload: true, mf_coin: WithAdministratorAppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
