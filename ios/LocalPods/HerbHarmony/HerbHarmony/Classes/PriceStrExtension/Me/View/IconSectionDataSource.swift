...
fileprivate let str_pointItemValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "JXBannerCellID" :*/
fileprivate let str_hiddenTitle:[Character] = ["J","X","B","a","n","n","e","r","C","e","l"]
fileprivate let str_recognizeData:[Character] = ["l","I","D"]
...
class IconSectionDataSource: UITableViewCell {
    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [CoverModelType]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_pointItemValue.reversed(), encoding: .utf8)!)
    }
...
extension IconSectionDataSource: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(str_hiddenTitle) + String(str_recognizeData)))
    }
...
extension IconSectionDataSource {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func eventLoad(bannerData: [CoverModelType]) {
