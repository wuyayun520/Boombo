...
class ScientificResearchScienceLabThen: UILabel {
    ...
    //: private func setup() {
    private func gloveComponent() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.userError().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.liveAttention(type: .Medium, fontSize: 11)
        font = UIFont.liveAttention(type: .Medium, fontSize: 11)
