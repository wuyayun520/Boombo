...
enum MakeViewConvertible: String {
    //: case AppleLogin
...
enum MasterAdditiveArithmetic: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum VolumeLeadingVarietyLoginType {
    //: case LoginPhone
    case LoginPhone
    //: case LoginEmail
    case LoginEmail
...
/// 性别
//: enum Gender: String {
enum MiniSubqueryConvertible: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum IconTermConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum MainWithConstantTarget: Int {
    //: case isOnGoing = 0
...
@objc enum SectionFreckleTextConvertible: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum TextHashable: Int {
    //: case Unavailable = 0
...
enum BringHomeCellType: CaseIterable {
