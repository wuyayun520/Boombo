...
fileprivate let str_viewRangeCellText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Cancel" :*/
fileprivate let str_timeData:[Character] = ["C","a","n","c","e","l"]

/*: "Sure" :*/
fileprivate let str_dataValue:String = "limit model gift near regularSure"
...
class PricePickView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_viewRangeCellText.reversed(), encoding: .utf8)!)
    }

    //: private func setupView() {
    private func underBlock() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(coldShoulder))
        ...
        cancelButton.setTitle((String(str_timeData)).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(nameButton(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(str_dataValue.suffix(4))).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(listenerTime(button:)), for: .touchUpInside)
    ...
    @objc func nameButton(button _: UIButton) {
        //: dismissView()
        coldShoulder()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func listenerTime(button _: UIButton) {
        //: dismissView()
        coldShoulder()
    }
