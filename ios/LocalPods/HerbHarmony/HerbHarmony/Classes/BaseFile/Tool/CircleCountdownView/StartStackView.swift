...
fileprivate let str_fromTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
let kLet_reasonNoTableContent = 3.0

//: class CircleCountdownView: UIView {
class StartStackView: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.colorPush() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_fromTitle.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        //: lab.textColor = .white
        lab.textColor = .white
        //: lab.font = UIFont.liveAttention(type: .Semibold, fontSize: 19)
        lab.font = UIFont.liveAttention(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: kLet_reasonNoTableContent / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: kLet_reasonNoTableContent / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - kLet_reasonNoTableContent,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - kLet_reasonNoTableContent)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.colorPush().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kLet_reasonNoTableContent
...
extension StartStackView {
    ...
    func timeObserver(totalTime: Int, currTime: Int) {
