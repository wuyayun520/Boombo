...
fileprivate let str_floorText:String = "btn_me_progress female make"
fileprivate let str_viewData:String = "bbecomek"
fileprivate let str_giftSizeContent:String = "attributeinue"

/*: "init(coder:) has not been implemented" :*/
fileprivate let str_awakeData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class TouchReactiveCompatible: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(nextUser), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(confinementClick), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: ManagerAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(str_floorText.prefix(7)) + str_viewData.replacingOccurrences(of: "become", with: "ac") + "_con" + str_giftSizeContent.replacingOccurrences(of: "attribute", with: "t"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_awakeData.reversed(), encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func addTouch(title: String, isTouch: Bool) {
